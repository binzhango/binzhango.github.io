...
:::note[Question 1: Model Size Must Match the Number of Tokens]{.question-note}
:::
...
:::note[Question 2: Repeated Epochs Reduce Model Performance]{.question-note}
:::
...
:::note[Question 3: Larger Datasets Mitigate Multi-Epoch Performance Drop]{.question-note}
:::
...
:::note[Question 4: Higher Data Quality Does Not Prevent Overfitting]{.question-note}
:::
...
:::note[Question 5: The Role of Parameters and FLOPs]{.question-note}
:::
...
:::note[Question 6: Small Models Overfit Just Like Large Models]{.question-note}
:::
...
:::note[Question 7: Can Multiple Training Objectives Help?]{.question-note}
:::
...
:::note[Question 8: Dropout: The Overlooked Regularization for LLMs]{.question-note}
:::
...
:::note[Question 9: Gradual Dropout Works Best]{.question-note}
:::
...
:::note[Question 10: Dropout Has Different Effects on Different Model Sizes]{.question-note}
:::
...
:::note[Question 11: Using MoE Models to Calibrate Dense Models]{.question-note}
:::
